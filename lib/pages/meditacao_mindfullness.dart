                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Meditação Mindfulness",textAlign: MediaQuery.of(context).size.width < 750 ? TextAlign.justify : TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),),
                        ],
                      ),
                      SizedBox(height: 20),
                      Text( "1. Escolha um local tranquilo e sente-se confortavelmente",  style: TextStyle(fontSize: 20,height: 1.8)),
                      Text( "2. Concentre-se na sua respiração, foque em cada inspiração e expiração",  style: TextStyle(fontSize: 20,height: 1.8),),
