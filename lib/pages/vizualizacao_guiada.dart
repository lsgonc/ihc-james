                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Vizualização Guiada",textAlign: MediaQuery.of(context).size.width < 750 ? TextAlign.justify : TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),),
                        ],
                      ),
                      SizedBox(height: 20),
                      Text( "1. Feche os olhos e respire profundamente para se acalmar..",  style: TextStyle(fontSize: 20,height: 1.8)),
                      Text( "2. Imagine um local tranquilo e sereno, como uma praia ou um campo.",  style: TextStyle(fontSize: 20,height: 1.8),),
                      Text( "3. Explore mentalmente esse ambiente, prestando atenção aos detalhes",  style: TextStyle(fontSize: 20,height: 1.8),),
                      Text( "4. Permita-se sentir a paz e a serenidade desse lugar imaginário.",  style: TextStyle(fontSize: 20,height: 1.8),),
