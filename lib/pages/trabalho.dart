              ...
              child: SizedBox(
                  ...
                  child: Column(
                      ...
                      children: [
                        RichText(
                            ...
                            text: TextSpan(
                                style: TextStyle(
                                    ...
                                    fontFamily: 'Roboto'),
                                text:
                                    "Compreendo que o trabalho pode ser desafiador e cansativo, e quero expressar minha admiração pela sua dedicação incansável. Sei que cada esforço no trabalho contribui para o seu crescimento e sucesso. Lembre-se de ",
                                children: <TextSpan>[
                                  TextSpan(
                                      text:
                                          "cuidar de si mesmo, permita-se pausas",
                                      style: TextStyle(
                                          color:
                                  ...
                                  TextSpan(
                                      text:
                                          " reconheça a importância do seu trabalho!,",
                                      style: TextStyle(
                                          color:
                                              Color.fromRGBO(0, 96, 150, 100))),
                                ])),
                        SizedBox(height: 20),
                        Text(
                            "Este cansaço é temporário, mas as conquistas quee você está alcançando são duradouras!",
                            textAlign: TextAlign.left,
                            style: TextStyle(
                                height: 1.3,
                                fontFamily: 'Roboto',
