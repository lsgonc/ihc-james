                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(text: "pequenos momentos de alegria ", style: TextStyle(color: Color.fromRGBO(0, 96, 150, 100))),
                      TextSpan(text: "no meio da rotina. Lembre-se de que está tudo bem pedir ajuda quando necessário."),
                    ])),
                SizedBox(height: 20),
                RichText(
                  textAlign: TextAlign.left,
